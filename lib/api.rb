...
class SimplyGive::API < SimplyGive::APIKey  # interact with the API
  ...
  def get_projects(cause:, next_page: nil)
    ...
    projects.each do |project|
      ...
      new_project = SimplyGive::Project.new(name: project["title"])
      ...
      new_project.charity = SimplyGive::Charity.new(name: project["organization"]["name"]).tap do |org|
